...
export const experiencesApi = {
  ...
  create: (data: FormData) =>
    api.post('/experiences', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  ...
  updateAvailability: (id: string, slots: unknown[]) =>
    api.put(`/experiences/${id}/availability`, { slots }),
};
...
export const bookingsApi = {
  ...
  getGuideBookings: (guideId: string, params?: Record<string, unknown>) =>
    api.get(`/guides/${guideId}/bookings`, { params }),
...
export const tripPlannerApi = {
  ...
  exportPdf: (id: string) =>
    api.get(`/trip-planner/itineraries/${id}/export`, { responseType: 'blob' }),
  shareLink: (id: string) => api.post(`/trip-planner/itineraries/${id}/share`),
  sendEmail: (id: string, email: string) =>
    api.post(`/trip-planner/itineraries/${id}/email`, { email }),
  addNote: (id: string, note: string) =>
    api.patch(`/trip-planner/itineraries/${id}/notes`, { note }),
};
...
export const adminApi = {
  ...
  rejectExperience: (id: string, reason: string) =>
    api.post(`/admin/experiences/${id}/reject`, { reason }),
  ...
  issueRefund: (paymentId: string, reason: string) =>
    api.post('/admin/refunds', { paymentId, reason }),
};
...
export const userApi = {
  ...
  addToWishlist: (id: string, experienceId: string) =>
    api.post(`/users/${id}/wishlist`, { experienceId }),
  removeFromWishlist: (id: string, experienceId: string) =>
    api.delete(`/users/${id}/wishlist/${experienceId}`),
};
