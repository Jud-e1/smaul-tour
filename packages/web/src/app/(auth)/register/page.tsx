    ...
    try {
      ...
      fetch('http://127.0.0.1:7530/ingest/996782cf-3a56-4e12-b167-d1376a9b8cab', {
        ...
        body: JSON.stringify({
          sessionId: 'a4fced',
          hypothesisId: 'H3',
          location: 'register/page.tsx:preRedirect',
          message: 'register redirect',
          data: { role: user?.role, hasUser: !!user },
          timestamp: Date.now(),
        }),
      }).catch(() => {});
      // #endregion
      ...
      fetch('http://127.0.0.1:7530/ingest/996782cf-3a56-4e12-b167-d1376a9b8cab', {
        ...
        body: JSON.stringify({
          sessionId: 'a4fced',
          hypothesisId: 'H5',
          location: 'register/page.tsx:catch',
          message: 'register ui err',
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#FF385C] to-[#E31C5F] flex-col justify-between p-12 text-white">
        ...
        <div>
          ...
          <p className="text-rose-100 text-sm leading-relaxed max-w-sm">
            Whether you're a traveler seeking adventure or a local guide ready to share your passion
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {(['traveler', 'guide'] as const).map((role) => (
                  <label
                    key={role}
                    className="flex items-center gap-2 border border-gray-300 rounded-xl p-3 cursor-pointer hover:bg-white transition-colors"
                  >
                    <input
                      type="radio"
                      value={role}
