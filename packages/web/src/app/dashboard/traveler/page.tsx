...
export default function TravelerDashboard() {
  ...
  useEffect(() => {
    ...
    bookingsApi
      .getUserBookings(user.id, { status: statusMap[bookingFilter] })
  ...
  const removePreference = (pref: string) => {
    setProfileForm((p) => ({
      ...p,
      travelPreferences: p.travelPreferences.filter((x) => x !== pref),
    }));
  };
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {booking.cancellationPolicy && (
                          <p className="text-xs text-gray-400 mt-1">
                            {CANCELLATION_POLICY_LABELS[booking.cancellationPolicy]}
                          </p>
                        )}
                        <div className="flex flex-wrap gap-2 mt-3">
                          ...
                          {booking.status === 'completed' && (
                            <button
                              ...
                              className="text-xs text-rose-500 border border-rose-200 px-3 py-1.5 rounded-lg hover:bg-rose-50 font-medium transition-colors"
                            >
                              ★ Leave Review
                            </button>
                          )}
                          <button
                            onClick={() => downloadConfirmation(booking.id)}
                          ...
                          {booking.paymentId && (
                            <button
                              onClick={() => downloadReceipt(booking.paymentId!)}
                              className="text-xs text-gray-500 border border-gray-200 px-3 py-1.5 rounded-lg hover:bg-gray-50 transition-colors"
                            >
                              Receipt
                            </button>
        ...
        {tab === 'itineraries' && (
          <div>
            <div className="flex justify-between items-center mb-5">
              ...
              <Link
                href="/trip-planner"
                className="text-sm bg-rose-500 text-white px-4 py-2 rounded-xl hover:bg-rose-600 font-medium transition-colors"
              >
                + New Itinerary
              </Link>
            </div>
              ...
              <div className="space-y-3">
                {itineraries.map((itin) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        <p className="font-semibold text-gray-900">
                          {itin.experiences.length} experience
                          {itin.experiences.length !== 1 ? 's' : ''}
                        </p>
                        <p className="text-sm text-gray-500 mt-0.5">
                          Generated{' '}
                          {new Date(itin.generatedAt).toLocaleDateString('en-US', {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric',
                          })}
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                          {itin.experiences
                            .slice(0, 3)
                            .map((e) => e.experience?.title || e.experienceId)
                            .join(' · ')}
                    ...
                    <div className="mt-3">
                      <Link
                        href={`/trip-planner?itinerary=${itin.id}`}
                        className="text-xs text-rose-500 border border-rose-200 px-3 py-1.5 rounded-lg hover:bg-rose-50 font-medium transition-colors inline-block"
                      >
                  ...
                  >
                    ...
                    <div className="p-4">
                      <Link
                        ...
                        className="font-semibold text-gray-900 hover:text-rose-500 transition-colors block"
                      >
                        {item.title}
                      </Link>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent resize-none"
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    className="flex-1 border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent"
                  />
                  <button
                    type="button"
                    onClick={addPreference}
                    className="px-3 py-2 bg-gray-100 text-gray-700 rounded-xl text-sm hover:bg-gray-200 font-medium"
                  >
                    Add
                  </button>
                </div>
                    ...
                    {profileForm.travelPreferences.map((pref) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="hover:text-rose-800 leading-none"
                        >
                          ×
                        </button>
                      </span>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-rose-500 to-pink-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:from-rose-600 hover:to-pink-700 disabled:opacity-50 transition-all shadow-sm"
              >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <p className="text-sm text-gray-600 mb-3">
              ...
              <span className="font-semibold">{cancelModal.experience?.title}</span>?
            </p>
            {cancelModal.cancellationPolicy && (
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4">
                ...
                <p className="text-xs text-amber-700">
                  {CANCELLATION_POLICY_LABELS[cancelModal.cancellationPolicy]}
                </p>
              </div>
            )}
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-r from-rose-500 to-pink-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:from-rose-600 hover:to-pink-700"
              >
                Submit Review
              </button>
            </div>
